...
\section{Future work}
\subsection{Co-occurrence vectors}
For our experiments would also be possible to use a soft-max or gaussian measure to weigh each word based on its distance, but we have weighted each of the 10 words in the 5 word window equally.
